        ...
        <div id="page-wrapper">
            ...
            <div class="content-mythe">
                <div class="content-mythe-one">
                    ...
                    <!-- 查询按钮 -->
                    <div class="butt-plains">
                        <el-button @click="getCheckedNodes"  icon="el-icon-search">查询</el-button>
                    </div>
                </div>
                <!-- 表格 -->
                <div class="content-mythe-two">
                    <div style="text-align: right;margin: 10px 20px;"><el-button size="mini" @click="tableDatak">清空</el-button></div>
                    <!-- 有按钮 -->
                    <el-table
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope">
                                ...
                                <el-progress type="circle" :percentage="scope.row.percentage" :width="30"></el-progress>
                                <el-button
                                size="mini"
        ...
        handleEdit(index, row) {
            ...
            this.$http.get(url).then(result=>{
                if (result.status == 200){
                    ...
                    //应该没用
                    // var url1 = root + "/api/v1/GetArchiveStatus?token="+roww+"&filename="+strFileName+"&session="+ this.$store.state.token;
                    // console.log(url1);
                    // this.$http.get(url1).then(result1=>{
                    //     console.log(result1.data.nPercentage);
                    //     row.percentage=result1.data.nPercentage;
